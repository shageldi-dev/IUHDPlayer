...
public class SecureActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if (VideoPlayerManager.getSetPass()) {
            this.title.setText("Giris kody giriziň");
        } else {
            this.title.setText("Täze parol giriziň");
        }
        if (VideoPlayerManager.getSetPass()) {
                ...
                if (charSequence.length() == 0) {
                    ...
                    if (!VideoPlayerManager.getSetPass()) {
                        if (SecureActivity.this.temp == 0) {
                            ...
                            SecureActivity.this.title.setText("Kod tassyklaň");
                            ...
                            Toast.makeText(SecureActivity.this, "Giriş kody üstünlikli düzüldi!", 0).show();
                        } else {
                            editText.setText("");
                            SecureActivity.this.temp = 0;
                            SecureActivity.this.title.setText("Täze parol giriziň");
                            Toast.makeText(SecureActivity.this, "Paroly şol bir tassyklaň!", 0).show();
                        }
                    } else if (VideoPlayerManager.getPass().equals(charSequence.toString())) {
                        SecureActivity.this.setPasswordSuccess();
                    } else {
                        editText.setText("");
                        Toast.makeText(SecureActivity.this, "Dogry giriş koduny giriziň!", 0).show();
                    }
                }
            }
        });
