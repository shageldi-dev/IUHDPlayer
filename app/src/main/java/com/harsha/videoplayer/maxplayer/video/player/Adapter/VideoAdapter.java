...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i2) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean z = true;
                VideoPlayerActivity.videosList = mediadatas;
                if (VideoAdapter.this.type == 0) {
                    ((HomeActivity) VideoAdapter.this.activity).myStartActivity(VideoPlayerActivity.getIntent(VideoAdapter.this.activity, null, viewHolder.getAdapterPosition()));
                } else if (VideoAdapter.this.type == 1) {
                    ((VideolistActivity) VideoAdapter.this.activity).myStartActivity(VideoPlayerActivity.getIntent(VideoAdapter.this.activity, null, viewHolder.getAdapterPosition()));
                } else {
                    ((HomeActivity) VideoAdapter.this.activity).myStartActivity(VideoPlayerActivity.getIntent(VideoAdapter.this.activity, null, viewHolder.getAdapterPosition()));
                }
                List list = (List) new Gson().fromJson(VideoPlayerManager.getRecentPlay(), new TypeToken<List<MediaData>>() {
