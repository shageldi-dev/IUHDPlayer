...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setUpMenu() {
        ...
        this.itemVideos = new ResideMenuItem(this, (int) R.drawable.ic_baseline_videocam_24, "Wideo");
        this.itemFolder = new ResideMenuItem(this, (int) R.drawable.ic_baseline_folder_24, "Bukja");
        this.itemRecent = new ResideMenuItem(this, (int) R.drawable.ic_baseline_access_time_24, "Soňky");
        this.itemHideVideos = new ResideMenuItem(this, (int) R.drawable.ic_baseline_lock_24, "Gizlin wideolar");
        this.itemRateUs = new ResideMenuItem(this, (int) R.drawable.ic_baseline_star_rate_24, "Baha beriň");
        this.itemShare = new ResideMenuItem(this, (int) R.drawable.ic_baseline_share_24, "Paýlaş");
        this.itemAboutUs = new ResideMenuItem(this, (int) R.drawable.ic_baseline_error_24, "Biz barada");
