...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initTab() {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Bukjalar"));
        TabLayout tabLayout2 = this.tablay;
        tabLayout2.addTab(tabLayout2.newTab().setText("Ähli wideolar"));
        TabLayout tabLayout3 = this.tablay;
        tabLayout3.addTab(tabLayout3.newTab().setText("Soňky"));
